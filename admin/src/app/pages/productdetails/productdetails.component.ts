      ...
      if (res && res.details) {
        ...
        if (this.productData.inventories && this.productData.inventories.length > 0) {
          for (var i = 0; i < this.productData.inventories.length; i++) {
            ...
            this.productData.inventories[i]['commission(%)']=this.productData.inventories[i].adminCommissionPercentage;
          
            delete this.productData.inventories[i].adminCommissionPercentage;
            delete this.productData.inventories[i].adminCommission;
          }
        }
