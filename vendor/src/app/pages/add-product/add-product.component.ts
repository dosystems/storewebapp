...
// to remove image color section
  ...
  SaveProduct(product,productForm) {
    ...
    product.name = this.appService.capitalize(productForm.value.name);
    if(productForm.value.shortDesc)
    product.shortDesc = this.appService.capitalize(productForm.value.shortDesc);
